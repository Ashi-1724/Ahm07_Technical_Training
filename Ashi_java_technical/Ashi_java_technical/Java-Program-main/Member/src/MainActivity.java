public class MainActivity {
    public static void main(String[] x) {
        ...
        Employee emp = new Employee("Jayy Marathe", 21, "9890562346", "123 Elm Street", 50000.0, "Software Engineering");
        ...
        Manager mgr = new Manager("Ashi Yadav", 21, "8160590035", "456 Oak Avenue", 75000.0, "Human Resources");
        System.out.println("\nManager Details:");
